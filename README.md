...
OnGrad introduces a novel way of estimating gradients to improve sample efficiency while still retaining quality.
...
2) We can see the quality of the estimate levels off at around 90% estimate threshold for a 0.9 momentum and level off at a higher and higher percentage as momentum gets bigger. This is the point of diminishing returns where it takes a lot of samples to improve the quality a little bit, if at all.
